            ...
            <div class="card">
                ...
                <div class="card-body">
                        <form action="{{ route('siswa.update', $siswa->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="radio" class="form-check-input" name="jeniskelamin" value="Laki - laki" {{ $siswa->jenis_kelamin == 'Laki - laki' ? 'checked' : ''}}  > Laki-laki
                            <input type="radio" class="form-check-input" name="jeniskelamin" value="Perempuan" {{ $siswa->jenis_kelamin == 'Perempuan' ? 'checked' : ''}}  > Perempuan 
                            </div>
                            <div class="mb-3">
