            ...
            <div class="card">
                ...
                <div class="card-body">
                        <form action="{{ route('order.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="number" placeholder="Input Quantity" name="quantity" class="form-control" required>
                            </div>
                            <div class="mb-3">
                            <label class="form-label">Order Date</label>
                            <input type="date" placeholder="Date Order" name="date" class="form-control" required>
                            </div>
                            <div class="mb-3">
